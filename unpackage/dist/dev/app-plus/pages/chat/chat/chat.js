...
/* harmony import */ var _pages_chat_chat_chat_nvue_mpType_page__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./pages/chat/chat/chat.nvue?mpType=page */ 141);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _chat_nvue_vue_type_template_id_91e38d04_mpType_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./chat.nvue?vue&type=template&id=91e38d04&mpType=page */ 142);
/* harmony import */ var _chat_nvue_vue_type_script_lang_js_mpType_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./chat.nvue?vue&type=script&lang=js&mpType=page */ 144);
...
var dom = weex.requireModule('dom');var _this;var JIM = getApp().globalData.JIM;var _default = { components: { freeNavBar: _freeNavBar.default, freeIconButton: _freeIconButton.default, freeChatItem: _freeChatItem.default, freePopup: _freePopup.default, freeMainButton: _freeMainButton.default }, data: function data() {return { // 模式 text输入文字，emoticon表情，action操作，audio音频
      ...
      unRecord: false };}, onLoad: function onLoad(e) {uni.$on("get_chat_msg", function () {console.log(__f__("===================有新消息来啦=====================", " at pages\\chat\\chat\\chat.nvue:193"));var msg = uni.getStorageSync(_this.username);_this.list = msg;var pageToBottomTimer = setTimeout(function () {_this.pageToBottom();clearTimeout(pageToBottomTimer);}, 200);});var pageToBottomTimer = setTimeout(function () {_this.pageToBottom();clearTimeout(pageToBottomTimer);}, 500);_this = this;_this.username = e.username;_this.nickname = e.nickname;_this.myUsername = uni.getStorageSync('setUserData').username;}, onUnload: function onUnload() {console.log(__f__("=================onUnload==================", " at pages\\chat\\chat\\chat.nvue:211"));uni.$off("get_chat_msg");}, onShow: function onShow() {console.log(__f__("chat__________________onSHow", " at pages\\chat\\chat\\chat.nvue:215")); // var imagepath=_this.image_cache("https://img.jiguang.cn/im-portal/0.0.1/assets/img/jverify-flow-banner-new.png","a");
    // var p = plus.io.convertLocalFileSystemURL(imagepath);  
    // console.log(p)
    var msg = uni.getStorageSync(_this.username);JIM.resetUnreadCount({ 'username': _this.username });if (msg) {_this.list = msg; // var pageToBottomTimer = setTimeout(()=>{
      // 	_this.pageToBottom()
      // 	clearTimeout(pageToBottomTimer)
      // },500)
    } else {console.log(__f__("hhhhhhhhhhhh", " at pages\\chat\\chat\\chat.nvue:230"));var now = new Date();
  ...
  onBackPress: function onBackPress(options) {
    console.log(__f__(options, " at pages\\chat\\chat\\chat.nvue:428"));
    console.log(__f__(JSON.stringify(options), " at pages\\chat\\chat\\chat.nvue:429"));
    if (options.from === 'backbutton' || options.from === 'navigateBack') {
      console.log(__f__("hhhh", " at pages\\chat\\chat\\chat.nvue:431"));
      uni.switchTab({
  ...
  (0, _vuex.mapMutations)(['regSendVoiceEvent']), {
      ...
      if (type == "image" || type == "audio" || type == "video") {
        uni.saveFile({
          ...
          success: function success(res) {
            ...
            console.log(__f__(data, " at pages\\chat\\chat\\chat.nvue:503"));
          } });

      }
      console.log(__f__(type + "=====" + data, " at pages\\chat\\chat\\chat.nvue:507"));
      switch (type) {
        case 'text':
          latest_msg = text;
          JIM.sendSingleMsg({
        ...
        case 'image':
          ...
          onSuccess(function (res, msg) {
            console.log(__f__(JSON.stringify(msg) + "===================", " at pages\\chat\\chat\\chat.nvue:570"));
            var obj = {
              "from_id": _this.myUsername,
              "create_time": new Date().getTime(),
              "msg_type": type,
        ...
        case 'audio':
          ...
          onSuccess(function (res, msg) {
            console.log(__f__(JSON.stringify(msg) + "===================", " at pages\\chat\\chat\\chat.nvue:626"));
            var obj = {
              "from_id": _this.myUsername,
              "create_time": new Date().getTime(),
              "msg_type": "file",
        ...
        case 'video':
          ...
          onSuccess(function (res, msg) {
            console.log(__f__(JSON.stringify(msg) + "===================", " at pages\\chat\\chat\\chat.nvue:734"));
            var obj = {
              "from_id": _this.myUsername,
    ...
    pageToBottom: function pageToBottom() {
      ...
      console.log(__f__("pageToBottom", " at pages\\chat\\chat\\chat.nvue:782"));
      this.$nextTick(function () {
        ...
        case 'uploadVideo': // 发送短视频
          uni.chooseVideo({
            ...
            success: function success(res) {
              ...
              console.log(__f__(res, " at pages\\chat\\chat\\chat.nvue:840"));
