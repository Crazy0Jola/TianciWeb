...
/* harmony import */ var _pages_chat_chat_chat_nvue_mpType_page__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./pages/chat/chat/chat.nvue?mpType=page */ 174);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _chat_nvue_vue_type_template_id_91e38d04_mpType_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./chat.nvue?vue&type=template&id=91e38d04&mpType=page */ 175);
/* harmony import */ var _chat_nvue_vue_type_script_lang_js_mpType_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./chat.nvue?vue&type=script&lang=js&mpType=page */ 177);
...
var _vuex = __webpack_require__(/*! vuex */ 92);var _components$data$onBa;function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};var ownKeys = Object.keys(source);if (typeof Object.getOwnPropertySymbols === 'function') {ownKeys = ownKeys.concat(Object.getOwnPropertySymbols(source).filter(function (sym) {return Object.getOwnPropertyDescriptor(source, sym).enumerable;}));}ownKeys.forEach(function (key) {_defineProperty(target, key, source[key]);});}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;} //
//
//
//
//
...
var dom = weex.requireModule('dom');var _this;var JIM = getApp().globalData.JIM;var SERVER_API = getApp().globalData.SERVER_API;var _default = (_components$data$onBa = { components: { freeNavBar: _freeNavBar.default, freeIconButton: _freeIconButton.default, freeChatItem: _freeChatItem.default, freePopup: _freePopup.default, freeMainButton: _freeMainButton.default }, data: function data() {return { // 模式 text输入文字，emoticon表情，action操作，audio音频
      ...
      unRecord: false };}, onBackPress: function onBackPress() {uni.switchTab({ url: "../../tabbar/index/index" });return true;}, onLoad: function onLoad(e) {uni.$on("get_chat_msg", function () {console.log(__f__("===================有新消息来啦=====================", " at pages\\chat\\chat\\chat.nvue:200"));var msg = uni.getStorageSync(_this.username);_this.list = msg;var pageToBottomTimer = setTimeout(function () {_this.pageToBottom();clearTimeout(pageToBottomTimer);}, 200);});var pageToBottomTimer = setTimeout(function () {_this.pageToBottom();clearTimeout(pageToBottomTimer);}, 500);_this = this;_this.username = e.username;_this.nickname = e.nickname;_this.avatar = e.avatar;var userData = uni.getStorageSync("setUserData");_this.myAvatar = userData.avatar;_this.myUsername = userData.username;}, onUnload: function onUnload() {console.log(__f__("=================onUnload==================", " at pages\\chat\\chat\\chat.nvue:221"));uni.$off("get_chat_msg");}, onShow: function onShow() {
    console.log(__f__("chat__________________onSHow", " at pages\\chat\\chat\\chat.nvue:225"));
    ...
    if (msg) {
      ...
      console.log(__f__("hhhhhhhhhhhh", " at pages\\chat\\chat\\chat.nvue:240"));
      var now = new Date();
...
options) {
  console.log(__f__(options, " at pages\\chat\\chat\\chat.nvue:421"));
  console.log(__f__(JSON.stringify(options), " at pages\\chat\\chat\\chat.nvue:422"));
  if (options.from === 'backbutton' || options.from === 'navigateBack') {
    console.log(__f__("hhhh", " at pages\\chat\\chat\\chat.nvue:424"));
    uni.switchTab({
...
(0, _vuex.mapMutations)(['regSendVoiceEvent']), {
    ...
    if (type == "image" || type == "audio" || type == "video") {
      uni.saveFile({
        ...
        success: function success(res) {
          ...
          console.log(__f__(data, " at pages\\chat\\chat\\chat.nvue:496"));
        } });

    }
    console.log(__f__(type + "=====" + data, " at pages\\chat\\chat\\chat.nvue:500"));
    switch (type) {
      case 'text':
        latest_msg = text;
        JIM.sendSingleMsg({
      ...
      case 'image':
        ...
        onSuccess(function (res, msg) {
          console.log(__f__(JSON.stringify(msg) + "===================", " at pages\\chat\\chat\\chat.nvue:563"));
          var obj = {
            "from_id": _this.myUsername,
            "create_time": new Date().getTime(),
            "msg_type": type,
      ...
      case 'audio':
        ...
        onSuccess(function (res, msg) {
          console.log(__f__(JSON.stringify(msg) + "===================", " at pages\\chat\\chat\\chat.nvue:619"));
          var obj = {
            "from_id": _this.myUsername,
            "create_time": new Date().getTime(),
            "msg_type": "file",
      ...
      case 'video':
        ...
        onSuccess(function (res, msg) {
          console.log(__f__(JSON.stringify(msg) + "===================", " at pages\\chat\\chat\\chat.nvue:727"));
          var obj = {
            "from_id": _this.myUsername,
  ...
  pageToBottom: function pageToBottom() {
    ...
    console.log(__f__("pageToBottom", " at pages\\chat\\chat\\chat.nvue:775"));
    this.$nextTick(function () {
  ...
  clickEvent: function clickEvent(event, e) {
    switch (event) {
      case 'copy': //复制
        if (this.propIndex > -1) {
          console.log(__f__(this.list[this.propIndex].msg_body.text, " at pages\\chat\\chat\\chat.nvue:797"));
        }
        break;
      ...
      case 'uploadVideo': // 发送短视频
        uni.chooseVideo({
          ...
          success: function success(res) {
            ...
            console.log(__f__(res, " at pages\\chat\\chat\\chat.nvue:843"));
