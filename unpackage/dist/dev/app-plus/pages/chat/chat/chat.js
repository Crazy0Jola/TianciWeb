...
/* harmony import */ var _pages_chat_chat_chat_nvue_mpType_page__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./pages/chat/chat/chat.nvue?mpType=page */ 146);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _chat_nvue_vue_type_template_id_91e38d04_mpType_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./chat.nvue?vue&type=template&id=91e38d04&mpType=page */ 147);
/* harmony import */ var _chat_nvue_vue_type_script_lang_js_mpType_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./chat.nvue?vue&type=script&lang=js&mpType=page */ 149);
...
var dom = weex.requireModule('dom');var _this;var JIM = getApp().globalData.JIM;var SERVER_API = getApp().globalData.SERVER_API;var _default = (_components$data$onBa = { components: { freeNavBar: _freeNavBar.default, freeIconButton: _freeIconButton.default, freeChatItem: _freeChatItem.default, freePopup: _freePopup.default, freeMainButton: _freeMainButton.default }, data: function data() {return { // 模式 text输入文字，emoticon表情，action操作，audio音频
      ...
      actionList: [[{ name: "相册", icon: "/static/images/extends/pic.png", event: "uploadImage" }, { name: "拍摄", icon: "/static/images/extends/video.png", event: "uploadVideo" }, { name: "名片", icon: "/static/images/extends/man.png", event: "noFun" }, { name: "位置", icon: "/static/images/extends/path.png", event: "noFun" }]], emoticonList: [], // 键盘高度
      ...
      unRecord: false };}, onBackPress: function onBackPress() {uni.switchTab({ url: "../../tabbar/index/index" });return true;}, onLoad: function onLoad(e) {uni.$on("get_chat_msg", function () {console.log(__f__("===================有新消息来啦=====================", " at pages\\chat\\chat\\chat.nvue:192"));var msg = uni.getStorageSync(_this.myUsername + _this.username);_this.list = msg;var pageToBottomTimer = setTimeout(function () {_this.pageToBottom();clearTimeout(pageToBottomTimer);}, 200);});var pageToBottomTimer = setTimeout(function () {_this.pageToBottom();clearTimeout(pageToBottomTimer);}, 500);_this = this;console.log(__f__(e.avatar, " at pages\\chat\\chat\\chat.nvue:205"));_this.username = e.username;_this.nickname = e.nickname;_this.avatar = e.avatar;var userData = uni.getStorageSync("setUserData");_this.myAvatar = userData.photo;_this.myUsername = userData.username;}, onUnload: function onUnload() {console.log(__f__("=================onUnload==================", " at pages\\chat\\chat\\chat.nvue:214"));uni.$off("get_chat_msg");}, onShow: function onShow() {console.log(__f__("chat__________________onSHow", " at pages\\chat\\chat\\chat.nvue:218")); // var imagepath=_this.image_cache("https://img.jiguang.cn/im-portal/0.0.1/assets/img/jverify-flow-banner-new.png","a");
    // var p = plus.io.convertLocalFileSystemURL(imagepath);  
    // console.log(p)
    var msg = uni.getStorageSync(_this.myUsername + _this.username);JIM.resetUnreadCount({ 'username': _this.username });if (msg) {_this.list = msg;
      // var pageToBottomTimer = setTimeout(()=>{
      // 	_this.pageToBottom()
      // 	clearTimeout(pageToBottomTimer)
      // },500)
    } else {
      console.log(__f__("hhhhhhhhhhhh", " at pages\\chat\\chat\\chat.nvue:233"));
      var now = new Date();
...
options) {
  console.log(__f__(options, " at pages\\chat\\chat\\chat.nvue:414"));
  console.log(__f__(JSON.stringify(options), " at pages\\chat\\chat\\chat.nvue:415"));
  if (options.from === 'backbutton' || options.from === 'navigateBack') {
    console.log(__f__("hhhh", " at pages\\chat\\chat\\chat.nvue:417"));
    uni.switchTab({
...
(0, _vuex.mapMutations)(['regSendVoiceEvent']), {
    ...
    if (type == "image" || type == "audio" || type == "video") {
      uni.saveFile({
        ...
        success: function success(res) {
          ...
          console.log(__f__(data, " at pages\\chat\\chat\\chat.nvue:489"));
        } });

    }
    console.log(__f__(type + "=====" + data, " at pages\\chat\\chat\\chat.nvue:493"));
    switch (type) {
      case 'text':
        latest_msg = text;
        JIM.sendSingleMsg({
      ...
      case 'image':
        ...
        onSuccess(function (res, msg) {
          console.log(__f__(JSON.stringify(msg) + "===================", " at pages\\chat\\chat\\chat.nvue:556"));
          var obj = {
            "from_id": _this.myUsername,
            "create_time": new Date().getTime(),
            "msg_type": type,
      ...
      case 'audio':
        ...
        onSuccess(function (res, msg) {
          console.log(__f__(JSON.stringify(msg) + "===================", " at pages\\chat\\chat\\chat.nvue:612"));
          var obj = {
            "from_id": _this.myUsername,
            "create_time": new Date().getTime(),
            "msg_type": "file",
      ...
      case 'video':
        ...
        JIM.sendSingleVedio({
          'target_username': _this.username, //用户名
          'file': data, //视频路径
          "extras": {
            "video": "mp4",
            'isremove': false,
  ...
  pageToBottom: function pageToBottom() {
    ...
    console.log(__f__("pageToBottom", " at pages\\chat\\chat\\chat.nvue:767"));
    this.$nextTick(function () {
  ...
  clickEvent: function clickEvent(event, e) {
    switch (event) {
      case 'copy': //复制
        if (this.propIndex > -1) {
          console.log(__f__(this.list[this.propIndex].msg_body.text, " at pages\\chat\\chat\\chat.nvue:789"));
        }
        break;
      ...
      case 'uploadVideo': // 发送短视频
        uni.chooseVideo({
          ...
          success: function success(res) {
            ...
            console.log(__f__(res, " at pages\\chat\\chat\\chat.nvue:835"));
