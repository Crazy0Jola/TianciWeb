...
/* harmony import */ var _pages_group_addGroup_addGroup_nvue_mpType_page__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./pages/group/addGroup/addGroup.nvue?mpType=page */ 58);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _addGroup_nvue_vue_type_template_id_fc308412_mpType_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./addGroup.nvue?vue&type=template&id=fc308412&mpType=page */ 59);
/* harmony import */ var _addGroup_nvue_vue_type_script_lang_js_mpType_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./addGroup.nvue?vue&type=script&lang=js&mpType=page */ 61);
    ...
    [
      _c(
        ...
        [
          _c(
            "free-nav-bar",
            { attrs: { title: "发起群聊", showBack: true, showRight: true } },
            [
              _c("free-main-button", {
                attrs: {
                  slot: "right",
...
//
//
var JIM = getApp().globalData.JIM;var _this;var _default = { components: { freeNavBar: _freeNavBar.default, freeListItem: _freeListItem.default, freeMainButton: _freeMainButton.default }, data: function data() {return { gid: '', gname: '', list: [{ "letter": "A", "data": ["test1", "test2", "阿勒", "阿里", "安庆", "澳机"] }, { "letter": "B", "data": ["保罗", "包头", "北海福成", "北南苑", "北都国际"] }, { "letter": "C", "data": ["长山场", "长国", "常德", "长花~", "长王", "常机", "成双", "赤峰"] }, { "letter": "D", "data": ["大理爱你", "大周哈哈", "达河", "丹浪", "德芒", "迪香里拉"] }, { "letter": "E", "data": ["鄂多斯"] },
  ...
  methods: {
    addGroup: function addGroup() {
      ...
      onSuccess(function (data) {
        console.log(__f__("=============" + data.gid + "============", " at pages\\group\\addGroup\\addGroup.nvue:322"));
        _this.gid = data.gid;
        JIM.addGroupMembers({
          'gid': data.gid,
      ...
      console.log(__f__(JSON.stringify(this.selectList), " at pages\\group\\addGroup\\addGroup.nvue:344"));
    },
