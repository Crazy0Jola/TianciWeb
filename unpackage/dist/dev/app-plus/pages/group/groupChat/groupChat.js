...
/* harmony import */ var _pages_group_groupChat_groupChat_nvue_mpType_page__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./pages/group/groupChat/groupChat.nvue?mpType=page */ 77);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _groupChat_nvue_vue_type_template_id_3cf55bf2_mpType_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./groupChat.nvue?vue&type=template&id=3cf55bf2&mpType=page */ 78);
/* harmony import */ var _groupChat_nvue_vue_type_script_lang_js_mpType_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./groupChat.nvue?vue&type=script&lang=js&mpType=page */ 80);
...
var _freeChatItem = _interopRequireDefault(__webpack_require__(/*! @/components/free-ui/free-chat-item.vue */ 82));
...
var dom = weex.requireModule('dom');var _this;var JIM = getApp().globalData.JIM;var _default = { components: { freeNavBar: _freeNavBar.default, freeIconButton: _freeIconButton.default, freeChatItem: _freeChatItem.default, freePopup: _freePopup.default, freeMainButton: _freeMainButton.default }, data: function data() {return { // 模式 text输入文字，emoticon表情，action操作，audio音频
      ...
      unRecord: false };}, onBackPress: function onBackPress() {uni.switchTab({ url: "../../tabbar/index/index" });return true;}, onLoad: function onLoad(e) {_this = this;_this.gid = e.gid;_this.gname = e.gname;_this.myUsername = uni.getStorageSync('setUserData').username;console.log(__f__("gid++++" + _this.gid + "----gname+" + _this.gname, " at pages\\group\\groupChat\\groupChat.nvue:211"));uni.$on("get_group_msg", function () {console.log(__f__("hhhhhhhhhhhhhhhhhhhhhh", " at pages\\group\\groupChat\\groupChat.nvue:214"));console.log(__f__("group" + _this.gid, " at pages\\group\\groupChat\\groupChat.nvue:215"));var msg = uni.getStorageSync("group" + _this.gid);console.log(__f__(JSON.stringify(msg), " at pages\\group\\groupChat\\groupChat.nvue:217"));_this.list = msg;var pageToBottomTimer = setTimeout(function () {_this.pageToBottom();clearTimeout(pageToBottomTimer);}, 200);});var pageToBottomTimer = setTimeout(function () {_this.pageToBottom();clearTimeout(pageToBottomTimer);}, 500);}, onUnload: function onUnload() {uni.$off("get_group_msg");},
  onShow: function onShow() {
    ...
    if (msg) {
      _this.list = msg;
      console.log(__f__(JSON.stringify(msg), " at pages\\group\\groupChat\\groupChat.nvue:244"));
      ...
      uni.request({
        ...
        success: function success(res) {
          console.log(__f__("====" + JSON.stringify(res), " at pages\\group\\groupChat\\groupChat.nvue:310"));
  ...
  (0, _vuex.mapMutations)(['regSendVoiceEvent']), {
      ...
      if (type == "image" || type == "audio" || type == "video") {
        uni.saveFile({
          ...
          success: function success(res) {
            ...
            console.log(__f__(data, " at pages\\group\\groupChat\\groupChat.nvue:527"));
          } });

      }
      console.log(__f__(type + "=====" + data, " at pages\\group\\groupChat\\groupChat.nvue:531"));
      switch (type) {
        case 'text':
          latest_msg = text;
          JIM.sendGroupMsg({
        ...
        case 'image':
          ...
          onSuccess(function (res, msg) {
            console.log(__f__(JSON.stringify(msg) + "===================", " at pages\\group\\groupChat\\groupChat.nvue:591"));
            var obj = {
              "from_id": _this.myUsername,
              "create_time": new Date().getTime(),
              "msg_type": type,
        ...
        case 'audio':
          ...
          onSuccess(function (res, msg) {
            console.log(__f__(JSON.stringify(msg) + "===================", " at pages\\group\\groupChat\\groupChat.nvue:646"));
            var obj = {
              "from_id": _this.myUsername,
              "create_time": new Date().getTime(),
              "msg_type": "file",
        ...
        case 'video':
          ...
          onSuccess(function (res, msg) {
            console.log(__f__(JSON.stringify(msg) + "===================", " at pages\\group\\groupChat\\groupChat.nvue:752"));
            var obj = {
              "from_id": _this.myUsername,
    ...
    pageToBottom: function pageToBottom() {
      ...
      console.log(__f__("pageToBottom", " at pages\\group\\groupChat\\groupChat.nvue:799"));
      this.$nextTick(function () {
        ...
        case 'uploadVideo': // 发送短视频
          uni.chooseVideo({
            ...
            success: function success(res) {
              ...
              console.log(__f__(res, " at pages\\group\\groupChat\\groupChat.nvue:857"));
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _free_chat_item_vue_vue_type_template_id_f1d74546_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./free-chat-item.vue?vue&type=template&id=f1d74546&scoped=true& */ 83);
/* harmony import */ var _free_chat_item_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./free-chat-item.vue?vue&type=script&lang=js& */ 85);
...
if(Vue.prototype.__merge_style){
              Vue.prototype.__merge_style(__webpack_require__(/*! ./free-chat-item.vue?vue&type=style&index=0&id=f1d74546&scoped=true&lang=css& */ 93).default, this.options.style)
          }else{
              Object.assign(this.options.style,__webpack_require__(/*! ./free-chat-item.vue?vue&type=style&index=0&id=f1d74546&scoped=true&lang=css& */ 93).default)
          }
            ...
            _vm.isother
              ? [
                  _c("free-avater", {
                    attrs: {
                      size: "70",
                      src: _vm.avatar || "/static/images/userpic.jpg",
                      clickType: "navigate"
                    }
                  }),
                  _vm.hasLabelClass
...
var _freeImage = _interopRequireDefault(__webpack_require__(/*! ./free-image.vue */ 87));
var _time = _interopRequireDefault(__webpack_require__(/*! @/common/free-lib/time.js */ 39));
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _free_image_vue_vue_type_template_id_fe20a960___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./free-image.vue?vue&type=template&id=fe20a960& */ 88);
/* harmony import */ var _free_image_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./free-image.vue?vue&type=script&lang=js& */ 90);
