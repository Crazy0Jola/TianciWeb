...
/* harmony import */ var _pages_tabbar_index_index_nvue_mpType_page__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./pages/tabbar/index/index.nvue?mpType=page */ 166);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _index_nvue_vue_type_template_id_0a607792_mpType_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.nvue?vue&type=template&id=0a607792&mpType=page */ 167);
...
function injectStyles (context) {
  ...
  if(!this.options.style){
      ...
      if(Vue.prototype.__merge_style){
                Vue.prototype.__merge_style(__webpack_require__(/*! ./index.nvue?vue&type=style&index=0&lang=css&mpType=page */ 171).default, this.options.style)
            }else{
                Object.assign(this.options.style,__webpack_require__(/*! ./index.nvue?vue&type=style&index=0&lang=css&mpType=page */ 171).default)
            }
...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni, __f__, plus) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _regenerator = _interopRequireDefault(__webpack_require__(/*! ./node_modules/@babel/runtime/regenerator */ 173));
...
var _freePopup = _interopRequireDefault(__webpack_require__(/*! @/components/free-ui/free-popup.vue */ 25));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function _asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);}function _throw(err) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);}_next(undefined);});};}
...
var _default = {
  ...
  onLoad: function onLoad() {
    ...
    uni.$on("get_index_msg", function () {
      ...
      JIM.getConversation().onSuccess(function (data) {
        console.log(__f__('success:Conversation222222===========' + JSON.stringify(data), " at pages\\tabbar\\index\\index.nvue:94"));
        ...
        if (tokenList.length > 0) {
          uni.request({
            ...
            success: function success(res) {
              console.log(__f__(res, " at pages\\tabbar\\index\\index.nvue:116"));
              for (var i = 0; i < len; i++) {
  ...
  onShow: function onShow() {
    ...
    if (JIM.isLogin()) {
      ...
      //获取会话列表
      JIM.getConversation().onSuccess(function (data) {
        console.log(__f__('success:Conversation222222===========' + JSON.stringify(data), " at pages\\tabbar\\index\\index.nvue:150"));
        _this.list = data.conversations.reverse();
        var tokenList = [];
        var len = _this.list.length;
        for (var i = 0; i < len; i++) {
        ...
        if (tokenList.length > 0) {
          uni.request({
            ...
            method: "POST",
            success: function success(res) {
              console.log(__f__(res, " at pages\\tabbar\\index\\index.nvue:172"));
              for (var i = 0; i < len; i++) {
                if (_this.list[i].type == 3) {//是单聊
                  var name = _this.list[i].username;
                  _this.list[i].avatar = res.data.result[name];
      ...
      if (value) {
        //有登录信息
        console.log(__f__("已登录用户：", value, " at pages\\tabbar\\index\\index.nvue:194"));
        if (JIM.isInit()) {
          ...
          uni.request({
            ...
            success: function success(res) {
              console.log(__f__(res, " at pages\\tabbar\\index\\index.nvue:212"));
              signature = res.data.result;
              console.log(__f__(signature, " at pages\\tabbar\\index\\index.nvue:214"));
              JIM.init({
                "appkey": appkey,
              ...
              onSuccess(function (data) {
                console.log(__f__('Init-success:' + JSON.stringify(data), " at pages\\tabbar\\index\\index.nvue:222"));
                _this.login(value.username, value.password);
              }).onFail(function (data) {
                uni.showToast({
                  "title": (0, _ErrorCode.default)(data.code),
  ...
  methods: {
    getPic: function getPic(media_id, index) {
      console.log(__f__(media_id + "==" + index, " at pages\\tabbar\\index\\index.nvue:261"));
      JIM.getResource({
        'media_id': media_id }).
    ...
    login: function () {var _login = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee3(username, password) {return _regenerator.default.wrap(function _callee3$(_context3) {while (1) {switch (_context3.prev = _context3.next) {case 0:
                ...
                onSuccess(function (data) {
                  ...
                  JIM.onMsgReceive( /*#__PURE__*/function () {var _ref = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee(data) {var noDisturb, i, content, type, latest_msg, list, username, gid;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
                              console.log(__f__("在线========" + JSON.stringify(data) + "===================================", " at pages\\tabbar\\index\\index.nvue:284"));

                              noDisturb = false;
                              for (i = 0; i < data.messages.length; i++) {
                                content = data.messages[i].content;
                                type = data.messages[i].msg_type;
                                ...
                                console.log(__f__("============" + latest_msg + "+=============", " at pages\\tabbar\\index\\index.nvue:307"));
                                ...
                                if (type == 3) {//如果是单聊消息
                                  ...
                                  if (content.msg_type == "text") {
                                    if (list) {
                                      list.push(content);
                                      console.log(__f__("======文字push", " at pages\\tabbar\\index\\index.nvue:319"));
                                  ...
                                  console.log(__f__("==========latest_mgs" + latest_msg, " at pages\\tabbar\\index\\index.nvue:326"));
                                  ...
                                  console.log(__f__("==============" + gid, " at pages\\tabbar\\index\\index.nvue:338"));
                                  console.log(__f__("group" + gid, " at pages\\tabbar\\index\\index.nvue:339"));
                                  list = uni.getStorageSync(_this.myUsername + gid); //获取该群聊的聊天记录缓存
                                  console.log(__f__(list, " at pages\\tabbar\\index\\index.nvue:341"));
                                  //如果是文字 直接push
                                  if (content.msg_type == "text") {
                                    if (list) {
                                      console.log(__f__("hhh", " at pages\\tabbar\\index\\index.nvue:345"));
                                      list.push(content);
                              ...
                              console.log(__f__("主页通知。。。。。。。。。。。。。。。。", " at pages\\tabbar\\index\\index.nvue:363"));
                              uni.$emit('get_index_msg', {});

                              if (type == 3) {
                                console.log(__f__("通知333333333333333333", " at pages\\tabbar\\index\\index.nvue:367"));
                                uni.$emit('get_chat_msg', {}); //通知单聊页面刷新获取数据
                              } else if (type == 4) {
                                console.log(__f__("通知444444444444444444444444", " at pages\\tabbar\\index\\index.nvue:370"));
                              ...
                              if (!noDisturb) {
                                ...
                                uni.vibrateLong({
                                  success: function success() {
                                    console.log(__f__('success', " at pages\\tabbar\\index\\index.nvue:381"));
                                  } });

                              }case 7:case "end":return _context.stop();}}}, _callee, this);}));return function (_x3) {return _ref.apply(this, arguments);};}());



                  JIM.onSyncConversation( /*#__PURE__*/function () {var _ref2 = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee2(data) {var i, latest_msg, last_content, username, list, j, content, gid, conversationTimer;return _regenerator.default.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0: //离线消息同步监听
                              console.log(__f__("SSSSSSSSSSSSSSSSSS" + JSON.stringify(data), " at pages\\tabbar\\index\\index.nvue:389"));
                              for (i = 0; i < data.length; i++) {

                                last_content = data[i].msgs[data[i].msgs.length - 1].content;
                                // 分类型进行判断
                                ...
                                if (data[i].msg_type == 3) {//如果是单聊
                                  ...
                                  list = uni.getStorageSync(_this.myUsername + username); //获取该对象的聊天记录

                                  //遍历该用户的消息
                                  for (j = 0; j < data[i].msgs.length; j++) {
                                    content = data[i].msgs[j].content;
                                  ...
                                  gid = data[i].from_gid;
                                  list = uni.getStorageSync(_this.myUsername + gid); //获取该对象的聊天记录
                              ...
                              conversationTimer = setTimeout(function () {
                                //获取会话列表
                                JIM.getConversation().onSuccess(function (data) {
                                  console.log(__f__('success:Conversation222222===========' + JSON.stringify(data), " at pages\\tabbar\\index\\index.nvue:459"));
                                  _this.list = data.conversations.reverse();
                                  var tokenList = [];
                                  var len = _this.list.length;
                                  for (var i = 0; i < len; i++) {
                                  ...
                                  if (tokenList.length > 0) {
                                    uni.request({
                                      ...
                                      method: "POST",
                                      success: function success(res) {
                                        console.log(__f__(res, " at pages\\tabbar\\index\\index.nvue:482"));
                              ...
                              }, 500);case 3:case "end":return _context2.stop();}}}, _callee2, this);}));return function (_x4) {return _ref2.apply(this, arguments);};}());



                  //获取会话列表
                  JIM.getConversation().onSuccess(function (data) {
                    console.log(__f__('success:Conversation222222===========' + JSON.stringify(data), " at pages\\tabbar\\index\\index.nvue:508"));
                    _this.list = data.conversations.reverse();
                    var tokenList = [];
                    var len = _this.list.length;
                    for (var i = 0; i < len; i++) {
                    ...
                    if (tokenList.length > 0) {
                      uni.request({
                        ...
                        method: "POST",
                        success: function success(res) {
                          console.log(__f__(res, " at pages\\tabbar\\index\\index.nvue:531"));
                          for (var i = 0; i < len - 1; i++) {
                            if (_this.list[i].type == 3) {//是单聊
                              var name = _this.list[i].username;
                              _this.list[i].avatar = res.data.result[name];
                  ...
                  console.log(__f__('error:' + JSON.stringify(data), " at pages\\tabbar\\index\\index.nvue:552"));
                  uni.showToast({
                    icon: 'none',
                    position: 'bottom',
                    title: (0, _ErrorCode.default)(data.code) });
                  ...
                  console.log(__f__('timeout:' + JSON.stringify(data), " at pages\\tabbar\\index\\index.nvue:559"));
                  uni.showToast({
                    icon: 'none',
                    position: 'bottom',
                    title: '登录超时！' });

                });case 3:case "end":return _context3.stop();}}}, _callee3, this);}));function login(_x, _x2) {return _login.apply(this, arguments);}return login;}(),
    ...
    isLogin: function isLogin() {
      ...
      try {
        ...
        if (value) {
          //有登录信息
          console.log(__f__("已登录用户：", value, " at pages\\tabbar\\index\\index.nvue:573"));
          if (!JIM.isLogin()) {
            _this.login(value.username, value.password);
          }
        } else {
    ...
    setPic: function setPic(media_id, username, content, list, type) {
      JIM.getResource({
        'media_id': media_id }).
      onSuccess(function (data) {
        uni.downloadFile({
            ...
            if (res.statusCode === 200) {
              uni.saveFile({
                ...
                success: function success(res) {
                  ...
                  if (list) {
                    list.push(content);
                    console.log(__f__("===============资源push", " at pages\\tabbar\\index\\index.nvue:602"));
                    uni.setStorageSync(_this.myUsername + username, list);
                    if (type == 3) {
                      uni.$emit('get_chat_msg', {}); //通知单聊页面刷新获取数据
                    } else if (type == 4) {
    ...
    long: function long(_ref3) {var x = _ref3.x,y = _ref3.y,index = _ref3.index;
      // 初始化 索引
    ...
    setTop: function setTop() {
      ...
      if (item.type == 3) {
        ...
        //获取会话列表
        JIM.getConversation().onSuccess(function (data) {
          console.log(__f__('success:Conversation222222===========' + JSON.stringify(data), " at pages\\tabbar\\index\\index.nvue:679"));
          _this.list = data.conversations.reverse();
          var tokenList = [];
          var len = _this.list.length;
          for (var i = 0; i < len; i++) {
          ...
          if (tokenList.length > 0) {
            uni.request({
              ...
              method: "POST",
              success: function success(res) {
                console.log(__f__(res, " at pages\\tabbar\\index\\index.nvue:701"));
                for (var i = 0; i < len; i++) {
                  if (_this.list[i].type == 3) {//是单聊
                    var name = _this.list[i].username;
                    _this.list[i].avatar = res.data.result[name];
        ...
        //获取会话列表
        JIM.getConversation().onSuccess(function (data) {
          console.log(__f__('success:Conversation222222===========' + JSON.stringify(data), " at pages\\tabbar\\index\\index.nvue:723"));
          _this.list = data.conversations.reverse();
          var tokenList = [];
          var len = _this.list.length;
          for (var i = 0; i < len; i++) {
          ...
          if (tokenList.length > 0) {
            uni.request({
              ...
              method: "POST",
              success: function success(res) {
                console.log(__f__(res, " at pages\\tabbar\\index\\index.nvue:745"));
                for (var i = 0; i < len; i++) {
                  if (_this.list[i].type == 3) {//是单聊
                    var name = _this.list[i].username;
                    _this.list[i].avatar = res.data.result[name];
