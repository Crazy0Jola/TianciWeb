...
if(Vue.prototype.__merge_style){
              Vue.prototype.__merge_style(__webpack_require__(/*! ./index.nvue?vue&type=style&index=0&lang=css&mpType=page */ 158).default, this.options.style)
          }else{
              Object.assign(this.options.style,__webpack_require__(/*! ./index.nvue?vue&type=style&index=0&lang=css&mpType=page */ 158).default)
          }
        ...
        [
          ...
          _vm._l(_vm.list, function(item, index) {
            return _c(
              ...
              { key: index },
              [
                _vm.isTop(item.username) && !item.extras.del
                  ? _c("free-media-list", {
...
//
//
var _this;var JIM = getApp().globalData.JIM;var _default = { components: { freeNavBar: _freeNavBar.default, freeMediaList: _freeMediaList.default, freePopup: _freePopup.default }, data: function data() {return { propIndex: -1, menus: [{ name: "设为置顶", event: "setTop" }, { name: "删除该聊天", event: "delChat" }], list: [] };}, onLoad: function onLoad() {uni.$on("get_index_msg", function () {//获取会话列表
      JIM.getConversation().onSuccess(function (data) {console.log(__f__('success:Conversation222222===========' + JSON.stringify(data), " at pages\\tabbar\\index\\index.nvue:83"));_this.list = data.conversations.reverse();}).onFail(function (data) {console.log(__f__('error:' + JSON.stringify(data), " at pages\\tabbar\\index\\index.nvue:86"));});});}, onUnload: function onUnload() {uni.$off("get_index_msg");uni.$off("JIMinit");uni.$off("reInit");}, onShow: function onShow() {_this = this;if (JIM.isLogin()) {// uni.showLoading({
      // 	title:"读取消息列表中..."
      // })
      //获取会话列表
      JIM.getConversation().onSuccess(function (data) {console.log(__f__('success:Conversation222222===========' + JSON.stringify(data), " at pages\\tabbar\\index\\index.nvue:104"));_this.list = data.conversations.reverse();uni.hideLoading();}).onFail(function (data) {
        console.log(__f__('error:' + JSON.stringify(data), " at pages\\tabbar\\index\\index.nvue:108"));
      });
      ...
      if (value) {
        //有登录信息
        console.log(__f__("已登录用户：", value, " at pages\\tabbar\\index\\index.nvue:116"));
        if (JIM.isInit()) {
          ...
          uni.request({
            ...
            success: function success(res) {
              console.log(__f__(res, " at pages\\tabbar\\index\\index.nvue:134"));
              signature = res.data.result;
              console.log(__f__(signature, " at pages\\tabbar\\index\\index.nvue:136"));
              JIM.init({
                "appkey": appkey,
              ...
              onSuccess(function (data) {
                console.log(__f__('Init-success:' + JSON.stringify(data), " at pages\\tabbar\\index\\index.nvue:144"));
                _this.login(value.username, value.password);
              }).onFail(function (data) {
                console.log(__f__('Init-error:' + JSON.stringify(data), " at pages\\tabbar\\index\\index.nvue:147"));
              });
            } });
  ...
  methods: {
    login: function login(username, password) {
      ...
      onSuccess(function (data) {
        ...
        JIM.onMsgReceive(function (data) {
          console.log(__f__(JSON.stringify(data) + "===================================", " at pages\\tabbar\\index\\index.nvue:195"));
          ...
          console.log(__f__('msg_receive:' + JSON.stringify(data), " at pages\\tabbar\\index\\index.nvue:246"));

          //获取会话列表
          JIM.getConversation().onSuccess(function (data) {
            console.log(__f__('success:Conversation33333333===========' + JSON.stringify(data), " at pages\\tabbar\\index\\index.nvue:250"));
            _this.list = data.conversations.reverse();
            uni.hideLoading();
          }).onFail(function (data) {
            console.log(__f__('error:' + JSON.stringify(data), " at pages\\tabbar\\index\\index.nvue:254"));
          });
        ...
        JIM.onEventNotification(function (data) {
          console.log(__f__('event_receive: ' + JSON.stringify(data), " at pages\\tabbar\\index\\index.nvue:263"));
        });
        ...
        JIM.onSyncConversation(function (data) {//离线消息同步监听
          ...
          var conversationTimer = setTimeout(function () {
            //获取会话列表
            JIM.getConversation().onSuccess(function (data) {
              console.log(__f__('success:Conversation3333===========' + JSON.stringify(data), " at pages\\tabbar\\index\\index.nvue:324"));
              _this.list = data.conversations.reverse();
              uni.hideLoading();
            }).onFail(function (data) {
              console.log(__f__('error:' + JSON.stringify(data), " at pages\\tabbar\\index\\index.nvue:328"));
            });
        ...
        JIM.onUserInfUpdate(function (data) {
          console.log(__f__('onUserInfUpdate : ' + JSON.stringify(data), " at pages\\tabbar\\index\\index.nvue:336"));
        });

        JIM.onSyncEvent(function (data) {
          console.log(__f__('onSyncEvent : ' + JSON.stringify(data), " at pages\\tabbar\\index\\index.nvue:340"));
        });

        JIM.onMsgReceiptChange(function (data) {
          console.log(__f__('onMsgReceiptChange : ' + JSON.stringify(data), " at pages\\tabbar\\index\\index.nvue:344"));
        });

        JIM.onSyncMsgReceipt(function (data) {
          console.log(__f__('onSyncMsgReceipt : ' + JSON.stringify(data), " at pages\\tabbar\\index\\index.nvue:348"));
        });

        JIM.onMutiUnreadMsgUpdate(function (data) {
          console.log(__f__('onConversationUpdate : ' + JSON.stringify(data), " at pages\\tabbar\\index\\index.nvue:352"));
        });

        JIM.onTransMsgRec(function (data) {
          console.log(__f__('onTransMsgRec : ' + JSON.stringify(data), " at pages\\tabbar\\index\\index.nvue:356"));
        });

        JIM.onRoomMsg(function (data) {
          console.log(__f__('onRoomMsg  : ' + JSON.stringify(data), " at pages\\tabbar\\index\\index.nvue:360"));
        });


        //获取会话列表
        JIM.getConversation().onSuccess(function (data) {
          console.log(__f__('success:Conversation===========' + JSON.stringify(data), " at pages\\tabbar\\index\\index.nvue:366"));
          _this.list = data.conversations.reverse();
          uni.hideLoading();
        }).onFail(function (data) {
          console.log(__f__('error:' + JSON.stringify(data), " at pages\\tabbar\\index\\index.nvue:370"));
        });

      }).onFail(function (data) {
        console.log(__f__('error:' + JSON.stringify(data), " at pages\\tabbar\\index\\index.nvue:374"));
        uni.showToast({
          icon: 'none',
          position: 'bottom',
        ...
        console.log(__f__('timeout:' + JSON.stringify(data), " at pages\\tabbar\\index\\index.nvue:381"));
        uni.showToast({
          icon: 'none',
          position: 'bottom',
          title: '登录超时！' });
    ...
    isLogin: function isLogin() {
      ...
      try {
        ...
        if (value) {
          //有登录信息
          console.log(__f__("已登录用户：", value, " at pages\\tabbar\\index\\index.nvue:395"));
          _this.login(value.username, value.password);
        } else {
          uni.reLaunch({
            url: '../../login/login' });
    ...
    setTop: function setTop() {
      ...
      //获取会话列表
      JIM.getConversation().onSuccess(function (data) {
        console.log(__f__('success:Conversation222222===========' + JSON.stringify(data), " at pages\\tabbar\\index\\index.nvue:445"));
        _this.list = data.conversations.reverse();
        uni.hideLoading();
      }).onFail(function (data) {
        console.log(__f__('error:' + JSON.stringify(data), " at pages\\tabbar\\index\\index.nvue:449"));
      });
    } } };exports.default = _default;
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/vue-cli-plugin-hbuilderx/packages/uni-app-plus-nvue-v8/dist/index.js */ 2)["default"], __webpack_require__(/*! ./node_modules/@dcloudio/vue-cli-plugin-uni/lib/format-log.js */ 30)["default"]))
...
//
//
var _this;var _default = { mixins: [_freeBase.default], components: { freeAvater: _freeAvater.default, freeBadge: _freeBadge.default }, data: function data() {return { istop: uni.getStorageSync(this.item.username + "isTop") || false };}, props: { item: Object, index: Number }, methods: { onClick: function onClick(e) {var username = e.currentTarget.attr.username;
...
/* 159 */
/*!***************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/@dcloudio/vue-cli-plugin-hbuilderx/packages/webpack-uni-nvue-loader/lib/style.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--9-oneOf-0-1!./node_modules/postcss-loader/src??ref--9-oneOf-0-2!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--9-oneOf-0-3!./node_modules/@dcloudio/vue-cli-plugin-hbuilderx/packages/vue-loader??ref--5-0!E:/天赐/TianciWeb/pages/tabbar/index/index.nvue?vue&type=style&index=0&lang=css&mpType=page ***!
  \***************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
