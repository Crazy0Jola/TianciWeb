...
/* harmony import */ var _pages_tabbar_my_my_nvue_mpType_page__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./pages/tabbar/my/my.nvue?mpType=page */ 180);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _my_nvue_vue_type_template_id_809c9010_mpType_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./my.nvue?vue&type=template&id=809c9010&mpType=page */ 181);
/* harmony import */ var _my_nvue_vue_type_script_lang_js_mpType_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./my.nvue?vue&type=script&lang=js&mpType=page */ 183);
...
//
//
var JIM = getApp().globalData.JIM;var SERVER_API = getApp().globalData.SERVER_API;var _this;var _default = { components: { freeNavBar: _freeNavBar.default, freeIconButton: _freeIconButton.default, freeListItem: _freeListItem.default, freeDivider: _freeDivider.default }, data: function data() {return { avatar: "", name: "", phone: "" };}, onShow: function onShow() {_this = this;var value = uni.getStorageSync('setUserData');_this.avatar = value.avatar;_this.name = value.name;_this.phone = value.phone;if (value) {//有登录信息
      console.log(__f__("已登录用户：", value, " at pages\\tabbar\\my\\my.nvue:72"));if (!JIM.isLogin()) {_this.login(value.username, value.password);}} else {uni.reLaunch({ url: '../../login/login' });}}, methods: { //图片缓存
    ...
    test: function test() {
      ...
      onSuccess(function (data) {
        console.log(__f__("===========" + JSON.stringify(data) + "=========", " at pages\\tabbar\\my\\my.nvue:123"));
        //data.code 返回码
        //data.message 描述
    ...
    test2: function test2() {
      var arr = ['18952158867'];
      uni.request({
        url: SERVER_API + "appUser/getUserPhotoByPhone",
        method: "POST",
        header: {
        ...
        success: function success(data) {
          console.log(__f__(JSON.stringify(data), " at pages\\tabbar\\my\\my.nvue:144"));
        } });
    ...
    test3: function test3() {
      ...
      onSuccess(function (data) {
        console.log(__f__(JSON.stringify(data), " at pages\\tabbar\\my\\my.nvue:152"));
        //data.code 返回码
        //data.message 描述
      ...
      uni.chooseImage({
        ...
        success: function success(res) {
          ...
          JIM.updateSelfAvatar({ 'avatar': res.tempFilePaths[0] }).onSuccess(function (data) {
            console.log(__f__('success:' + JSON.stringify(data), " at pages\\tabbar\\my\\my.nvue:194"));
