...
/* harmony import */ var _pages_tabbar_my_my_nvue_mpType_page__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./pages/tabbar/my/my.nvue?mpType=page */ 147);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _my_nvue_vue_type_template_id_809c9010_mpType_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./my.nvue?vue&type=template&id=809c9010&mpType=page */ 148);
/* harmony import */ var _my_nvue_vue_type_script_lang_js_mpType_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./my.nvue?vue&type=script&lang=js&mpType=page */ 150);
      ...
      _c(
        ...
        [
          ...
          _c(
            "free-list-item",
            {
              attrs: { title: "退出登录", showRight: true },
              on: { click: _vm.exit }
            },
            [
              _c(
...
var _ErrorCode = _interopRequireDefault(__webpack_require__(/*! @/js_sdk/ErrorCode.js */ 152));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} //
//
//
//
//
...
//
//
var JIM = getApp().globalData.JIM;var _default = { components: { freeNavBar: _freeNavBar.default, freeIconButton: _freeIconButton.default, freeListItem: _freeListItem.default, freeDivider: _freeDivider.default }, data: function data() {return { url: "" };}, onShow: function onShow() {var imagepath = this.image_cache("https://img.jiguang.cn/im-portal/0.0.1/assets/img/jverify-flow-banner-new.png", "b");var p = plus.io.convertLocalFileSystemURL(imagepath);console.log(__f__(p, " at pages\\tabbar\\my\\my.nvue:62"));this.url = p;var value = uni.getStorageSync('setUserData');if (value) {//有登录信息
      console.log(__f__("已登录用户：", value, " at pages\\tabbar\\my\\my.nvue:67"));if (!JIM.isLogin()) {_this.login(value.username, value.password);}} else {uni.reLaunch({ url: '../../login/login' });}}, methods: { //图片缓存
    image_cache: function image_cache(image_url, media_id) {var url;uni.getStorage({ key: media_id, success: function success(res) {url = res.data.tempFilePath;
        },
    ...
    test4: function test4() {
      ...
      uni.navigateTo({
        url: "/pages/chat/video/video?url=".concat(url) });
    ...
    test: function test() {
      ...
      onSuccess(function (data) {
        console.log(__f__("===========" + JSON.stringify(data) + "=========", " at pages\\tabbar\\my\\my.nvue:118"));
        //data.code 返回码
        //data.message 描述
    ...
    test2: function test2() {
      ...
      uni.request({
        ...
        success: function success(data) {
          console.log(__f__(JSON.stringify(data), " at pages\\tabbar\\my\\my.nvue:139"));
        } });
    ...
    test3: function test3() {
      ...
      onSuccess(function (data) {
        console.log(__f__(JSON.stringify(data), " at pages\\tabbar\\my\\my.nvue:147"));
        //data.code 返回码
        //data.message 描述
    ...
    changeAvator: function changeAvator() {
      ...
      uni.chooseImage({
        ...
        success: function success(res) {
          ...
          JIM.updateSelfAvatar({ 'avatar': res.tempFilePaths[0] }).onSuccess(function (data) {
            console.log(__f__('success:' + JSON.stringify(data), " at pages\\tabbar\\my\\my.nvue:188"));
