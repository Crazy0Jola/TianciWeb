...
/* harmony import */ var _login_vue_vue_type_template_id_13f1d6bb___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./login.vue?vue&type=template&id=13f1d6bb& */ 162);
...
/* harmony import */ var _login_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./login.vue?vue&type=style&index=0&lang=css& */ 169);
...
var _login = __webpack_require__(/*! @/service/api/login.js */ 166);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} //
//
//
//
//
...
//
//
var _this;var wInput = function wInput() {return __webpack_require__.e(/*! import() | components/watch-login/watch-input */ "components/watch-login/watch-input").then(__webpack_require__.bind(null, /*! @/components/watch-login/watch-input.vue */ 283));};var wButton = function wButton() {return __webpack_require__.e(/*! import() | components/watch-login/watch-button */ "components/watch-login/watch-button").then(__webpack_require__.bind(null, /*! @/components/watch-login/watch-button.vue */ 290));}; //登录api
var JIM = getApp().globalData.JIM;var SERVER_API = getApp().globalData.SERVER_API;var _default = { data: function data() {return { //logo图片 base64
    ...
    };}, components: { wInput: wInput, wButton: wButton }, mounted: function mounted() {_this = this;}, methods: { login: function login(username, password) {uni.request({ url: SERVER_API + "appUser/userLogin", data: { phone: username, password: password }, header: { token: "fc45399fc19a48c6b893c27fd2e6b031" }, success: function success(res) {if (res.data.code == 1) {JIM.login({ 'username': username, 'password': password }).onSuccess(function (data) {console.log('success:' + JSON.stringify(data));
