...
//
//
var _this;var wInput = function wInput() {return __webpack_require__.e(/*! import() | components/watch-login/watch-input */ "components/watch-login/watch-input").then(__webpack_require__.bind(null, /*! @/components/watch-login/watch-input.vue */ 246));};var wButton = function wButton() {return __webpack_require__.e(/*! import() | components/watch-login/watch-button */ "components/watch-login/watch-button").then(__webpack_require__.bind(null, /*! @/components/watch-login/watch-button.vue */ 253));}; //登录api
var JIM = getApp().globalData.JIM;var _default = { data: function data() {return { //logo图片 base64
    ...
    };}, components: { wInput: wInput, wButton: wButton }, mounted: function mounted() {_this = this;}, methods: { login: function login(username, password) {JIM.login({ 'username': username, 'password': password }).onSuccess(function (data) {console.log('success:' + JSON.stringify(data));JIM.onMsgReceive(function (data) {data = JSON.stringify(data);console.log('msg_receive:' + data);});JIM.onEventNotification(function (data) {console.log('event_receive: ' + JSON.stringify(data));});JIM.onSyncConversation(function (data) {//离线消息同步监听
          console.log(data);});JIM.onUserInfUpdate(function (data) {
